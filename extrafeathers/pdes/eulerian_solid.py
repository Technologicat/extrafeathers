...
class EulerianSolid:
    ...
    def compile_forms(self) -> None:
        ...
        if self.τ == 0.0:  # Linear elastic (LE)
            ...
            F_σ = (inner(Σ, φ) * dx -
                   inner(K_inner_εu + τ * K_inner_εv, φ) * dx -  # linear elastic and τ ∂/∂t (...)
                   τ * dot(a, n) * inner(K_inner_εu, φ) * ds +  # generated by ∫ (φ:Kη):(a·∇)ε dx
                   τ * inner(K_inner_εu, advs(a, φ)) * dx)  # generated by ∫ (φ:Kη):(a·∇)ε dx
