...
bcσ.append((Constant(((1e8, 0), (0, 0))), None))
# This does not work as-is, we would need a rigid-body mode remover.
# But obviously, if we fix the displacement somewhere, the solution will be unique.
# So let's fix the displacement at the center point of the domain. Note this needs
# a regular mesh to work properly, because we need to have a DOF exactly at the center.
#
